...
import { login_user } from '../feature/slice'; 
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="bg-white p-8 rounded-lg shadow-md w-96">
        <h2 className="text-2xl font-semibold text-center mb-2">Log in to your account</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* <button type="submit" className="w-full bg-pink-500 text-white py-2 rounded-md font-semibold" disabled={status === "loading"}>
        ...
        <p className="text-center text-gray-600 mt-4">Don't have an account? <Link href="sign-up" className="text-pink-500">Sign Up</Link></p>
      </div>
    </div>
  );
}
